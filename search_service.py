...
class SearchService:
    ...
    async def search(self, query: str, max_results: int = 5) -> str:
        """Perform internet search using available search APIs"""
        try:
            # Try Tavily first
            ...
            # If no API keys available, return empty result
    ...
    async def _search_tavily(self, query: str, max_results: int) -> Optional[str]:
    ...
    async def _search_serpapi(self, query: str, max_results: int) -> Optional[str]:
